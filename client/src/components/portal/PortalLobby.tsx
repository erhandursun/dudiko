            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-8">
                    ...
                    >
                        ...
                        <p className="text-cyan-400/60 font-medium tracking-wide">HOŞ GELDİN, <span className="text-white font-bold">{(myName || 'MİSAFİR').toUpperCase()}</span>. BİR MACERA SEÇ.</p>
                    </motion.div>
                ...
                <motion.div
                    ...
                    className="relative w-full h-[400px] rounded-[48px] overflow-hidden mb-12 group cursor-pointer border border-white/5 shadow-2xl"
                ...
                >
                    ...
                    <div className="absolute bottom-0 left-0 w-full p-12 z-20">
                        <div className="inline-block px-4 py-1 bg-cyan-500 text-white text-[10px] font-black rounded-full mb-4 uppercase tracking-widest">ÖNE ÇIKAN</div>
                        <h2 className="text-5xl font-black mb-4 tracking-tighter italic text-white uppercase">MATEMATİK YARIŞI</h2>
                        <p className="text-lg text-white/70 max-w-xl mb-8 font-medium">2, 3 ve 4'ler çarpım tablosunu eğlenerek öğren! Arkadaşlarınla yarış ve puan topla.</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {games.map((game, idx) => (
                        <motion.div
                            ...
                            className="group relative h-[320px] rounded-[40px] overflow-hidden border border-white/10 hover:border-cyan-500/50 transition-all cursor-pointer bg-white/5 shadow-xl"
                        ...
                        >
                            ...
                            <div className="absolute top-4 right-4 z-20 flex gap-2">
                                <span className="bg-black/40 backdrop-blur-md border border-white/10 px-3 py-1 rounded-full text-[10px] font-black text-white uppercase">
                                    {game.category}
                                </span>
                                {game.multiplayer && (
                                    <span className="bg-cyan-500/40 text-white backdrop-blur-md border border-cyan-500/30 px-3 py-1 rounded-full text-[10px] font-black uppercase">
                                        MULTIPLAYER
                                    </span>
                                )}
                            </div>
                            ...
                            <div className="absolute bottom-0 left-0 w-full p-8 z-20">
                                ...
                                <div className="flex items-center gap-4 text-white/50 group-hover:text-white transition-all text-xs font-black uppercase tracking-widest">
